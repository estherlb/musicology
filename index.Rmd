...
grid.arrange(grob0, grob1, nrow = 1)
```
...
To know how well the model did, presicion and recall can be calculated, and it show the model did pretty well.

<img src="MLrecall.PNG">
...
On the left the we see the tempogram of the track [Alice's Theme - Danny Elfman](https://open.spotify.com/album/4HcpykTFR8ZfyyrOX9jNJo?highlight=spotify:track:11liAe3FvMGspJ9x3a1xw4) is shown.

You can see three yellow lines at 100, 250 and 350 BPM.
...
The first graph has some yellow lines. You can see a line at 200 BPM that increases slightly and you also see what activity just above 400. The second soundtrack starts after about 1 minute, and you can see it has around the same BPM as the first one.
