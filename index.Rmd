...
### Chromagran Alice in Wonderland themesong
```{r}
alice_theme <-
...
As was shown in the visualisations, the tempo of the different playlists didn't really differ from eachother. To know what soundtrack would fit the best in my favorite songs playlist, the average tempo of my favorite songs were calculated. \
